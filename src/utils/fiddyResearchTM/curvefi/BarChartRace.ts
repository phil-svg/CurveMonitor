...
async function saveToJsonFile(filePath: string, data: any): Promise<void> {
  try {
...
function createDummyBarChartRaceData(startYear: number, startMonth: number, endYear: number, endMonth: number, addresses: string[]): any[] {
...
export async function barChartRace(): Promise<void> {
  // Example usage:
