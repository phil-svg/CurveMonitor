...
export function getUniswapV3Contract(contractAddress: string): any {
  const abiV3: any = [
  ...
  return new WEB3_HTTP_PROVIDER.eth.Contract(abiV3, contractAddress);
}

export function getUniswapV2Contract(contractAddress: string): any {
  const abiV3: any = [
