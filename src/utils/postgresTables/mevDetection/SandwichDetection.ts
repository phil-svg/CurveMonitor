...
async function candidateLength2(candidate: TransactionData[]): Promise<void> {
...
async function candidateLength3(candidate: TransactionData[]): Promise<void> {
...
async function candidateWithThreeConsecutiveTransactions(candidate: TransactionData[]): Promise<void> {
