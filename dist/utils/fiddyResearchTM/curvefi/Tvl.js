...
export async function getPoolTokenBalancesAtBlock(poolAddress, blockNumber) {
...
export function getBlockNumberAtTime(unixtime) {
...
export async function calculateTVLChangesOverTime(poolAddress, startDate, endDate) {
    ...
    const tvlChanges = initialBalances.map((balance) => ({
...
export async function tvlThings() {
