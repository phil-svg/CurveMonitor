...
async function fetchDataThenDetectArb(txHash) {
    ...
    const transfersCategorized = await getCategorizedTransfersFromTxTrace(cleanedTransfers, from, to);
    // console.dir(transfersCategorized, { depth: null, colors: true });
    // await solveAtomicArb(txHash!, transfersCategorized, cleanedTransfers, from, to);
}
