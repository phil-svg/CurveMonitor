...
export async function fetchCexDexArbTxIdsForPoolAndTime(poolId, startUnixtime, endUnixtime) {
...
export async function printCexDexBotAddressCounts() {
    try {
        ...
        botAddressCounts.forEach((entry) => {
