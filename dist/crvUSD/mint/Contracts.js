...
export async function getMintMarketControllerContract(address) {
...
export async function getMintMarketLlammaContract(address) {
    const abi = getMintMarketLlammaAbi();
    return new WEB3_HTTP_PROVIDER.eth.Contract(abi, address);
}
export async function getLlammaContract(llammaAddress) {
    const ABI = [
        {
            name: 'TokenExchange',
            inputs: [
