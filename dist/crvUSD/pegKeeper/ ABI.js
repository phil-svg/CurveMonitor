export const PEGKEEPER_ABI = [
    ...
    },
    {
        ...
        inputs: [{ name: 'action_delay', type: 'uint256', indexed: false }],
        anonymous: false,
        type: 'event',
    },
    {
        name: 'SetNewCallerShare',
        inputs: [{ name: 'caller_share', type: 'uint256', indexed: false }],
        anonymous: false,
        type: 'event',
    },
    {
        name: 'SetNewRegulator',
        inputs: [{ name: 'regulator', type: 'address', indexed: false }],
        anonymous: false,
        type: 'event',
    },
    {
    ...
    },
    {
        stateMutability: 'nonpayable',
        type: 'function',
        name: 'set_new_action_delay',
        inputs: [{ name: '_new_action_delay', type: 'uint256' }],
        outputs: [],
    },
    {
        stateMutability: 'nonpayable',
        ...
        inputs: [{ name: '_new_caller_share', type: 'uint256' }],
        outputs: [],
    },
    {
        stateMutability: 'nonpayable',
        type: 'function',
        name: 'set_new_regulator',
        inputs: [{ name: '_new_regulator', type: 'address' }],
        outputs: [],
    },
    {
        stateMutability: 'nonpayable',
    ...
    { stateMutability: 'view', type: 'function', name: 'IS_INVERSE', inputs: [], outputs: [{ name: '', type: 'bool' }] },
    { stateMutability: 'view', type: 'function', name: 'IS_NG', inputs: [], outputs: [{ name: '', type: 'bool' }] },
    {
        stateMutability: 'view',
        type: 'function',
        name: 'regulator',
